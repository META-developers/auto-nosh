...
@InputType()
class BusinessCreateNestedManyWithoutBusinessTypesInput {
...
export { BusinessCreateNestedManyWithoutBusinessTypesInput as BusinessCreateNestedManyWithoutBusinessTypesInput };
