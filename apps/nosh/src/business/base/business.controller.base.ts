...
import { CuisineTypeFindManyArgs } from "../../cuisineType/base/CuisineTypeFindManyArgs";
...
export class BusinessControllerBase {
  ...
  async findManyCuisineTypes(
    ...
    const query = plainToClass(CuisineTypeFindManyArgs, request.query);
  ...
  async connectCuisineTypes(
    @common.Param() params: BusinessWhereUniqueInput,
    @common.Body() body: CuisineTypeWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      cuisineTypes: {
        connect: body,
