...
@InputType()
class BusinessCreateNestedManyWithoutLocationsInput {
...
export { BusinessCreateNestedManyWithoutLocationsInput as BusinessCreateNestedManyWithoutLocationsInput };
