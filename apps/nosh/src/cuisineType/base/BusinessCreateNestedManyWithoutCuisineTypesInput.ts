...
@InputType()
class BusinessCreateNestedManyWithoutCuisineTypesInput {
...
export { BusinessCreateNestedManyWithoutCuisineTypesInput as BusinessCreateNestedManyWithoutCuisineTypesInput };
