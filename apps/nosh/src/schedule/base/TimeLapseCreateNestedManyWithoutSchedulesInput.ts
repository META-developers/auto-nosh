...
@InputType()
class TimeLapseCreateNestedManyWithoutSchedulesInput {
...
export { TimeLapseCreateNestedManyWithoutSchedulesInput as TimeLapseCreateNestedManyWithoutSchedulesInput };
