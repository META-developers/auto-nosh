...
@ArgsType()
class UpdateSuboptionArgs {
  @Field(() => SuboptionWhereUniqueInput, { nullable: false })
  where!: SuboptionWhereUniqueInput;
  @Field(() => SuboptionUpdateInput, { nullable: false })
  data!: SuboptionUpdateInput;
}

export { UpdateSuboptionArgs as UpdateSuboptionArgs };
