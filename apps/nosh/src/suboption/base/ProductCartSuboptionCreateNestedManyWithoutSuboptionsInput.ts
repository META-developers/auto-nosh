...
@InputType()
class ProductCartSuboptionCreateNestedManyWithoutSuboptionsInput {
...
export { ProductCartSuboptionCreateNestedManyWithoutSuboptionsInput as ProductCartSuboptionCreateNestedManyWithoutSuboptionsInput };
