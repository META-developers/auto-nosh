...
@InputType()
class ProductCartCreateNestedManyWithoutProductsInput {
...
export { ProductCartCreateNestedManyWithoutProductsInput as ProductCartCreateNestedManyWithoutProductsInput };
