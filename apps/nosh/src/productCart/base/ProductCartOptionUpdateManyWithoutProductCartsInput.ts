...
@InputType()
class ProductCartOptionUpdateManyWithoutProductCartsInput {
...
export { ProductCartOptionUpdateManyWithoutProductCartsInput as ProductCartOptionUpdateManyWithoutProductCartsInput };
