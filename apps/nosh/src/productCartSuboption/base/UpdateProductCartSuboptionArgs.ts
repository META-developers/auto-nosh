...
@ArgsType()
class UpdateProductCartSuboptionArgs {
  @Field(() => ProductCartSuboptionWhereUniqueInput, { nullable: false })
  where!: ProductCartSuboptionWhereUniqueInput;
  @Field(() => ProductCartSuboptionUpdateInput, { nullable: false })
  data!: ProductCartSuboptionUpdateInput;
}

export { UpdateProductCartSuboptionArgs as UpdateProductCartSuboptionArgs };
