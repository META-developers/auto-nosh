...
@InputType()
class ProductCartOptionCreateNestedManyWithoutProductCartSuboptionsInput {
...
export { ProductCartOptionCreateNestedManyWithoutProductCartSuboptionsInput as ProductCartOptionCreateNestedManyWithoutProductCartSuboptionsInput };
