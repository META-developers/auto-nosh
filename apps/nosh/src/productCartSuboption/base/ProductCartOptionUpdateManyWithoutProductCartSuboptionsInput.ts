...
@InputType()
class ProductCartOptionUpdateManyWithoutProductCartSuboptionsInput {
...
export { ProductCartOptionUpdateManyWithoutProductCartSuboptionsInput as ProductCartOptionUpdateManyWithoutProductCartSuboptionsInput };
